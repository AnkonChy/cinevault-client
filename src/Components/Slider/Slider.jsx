...
const Slider = () => {
  return (
    ...
    >
      <SwiperSlide>
        <img
          className="w-full h-[232px] md:h-[350px] lg:h-[550px] object-cover"
      ...
      <SwiperSlide>
        <img
          className="w-full h-[232px] md:h-[350px] lg:h-[550px] object-top"
      ...
      <SwiperSlide>
        <img
          className="w-full h-[232px] md:h-[350px] lg:h-[550px] lg:object-cover"
          src="https://i.ibb.co.com/kHRjz6x/FNUS4-Fp-X0-Ac-UE1c.jpg"
          alt=""
        />
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-black/40 to-transparent"></div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <img
          className="w-full h-[232px] md:h-[350px] lg:h-[550px] lg:object-fill"
